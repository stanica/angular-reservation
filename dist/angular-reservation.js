...
angular.module("hm.reservation").run(["$templateCache", function($templateCache) {$templateCache.put("availableHours.html","<a class=\"list-group-item\" ng-repeat=\"item in reservationCtrl.availableHours\" ng-click=\"reservationCtrl.selectHour(item)\"\n   ng-class=\"{\'angular-reservation-selected\': reservationCtrl.selectedHour == item}\">\n    <div style=\"display:inline-block\"><span>{{item.startTime | ignoreTimeZone | date  : \'shortTime\'}}</span></div>\n    <div style=\"display:inline-block;float:right\"><span>{{item.numSeatsAvailable}} slots</span></div>\n</a>");
